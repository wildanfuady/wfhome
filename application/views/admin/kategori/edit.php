        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin90/kategori/edit/'.$category['category_id']) ?>">Edit</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?= form_open('admin90/kategori/update/'.$category['category_id']) ?>
            <div class="card-body">
                <div class="form-group">
                    <label for="">Nama Kategori</label>
                    <?= form_input('category_name', $category['category_name'], ['class' => 'form-control', 'placeholder' => 'Nama Kategori', 'required' => 'required']) ?>
                </div>
                <div class="form-group">
                    <label for="">Status Kategori</label>
                    <?= form_dropdown('category_status', ['' => 'Pilih Status', 'Y' => 'Active', 'N' => 'Non Active'], $category['category_status'], ['class' => 'form-control', 'required' => 'required']) ?>
                </div>
                <div class="form-group">
                    <label for="">Tampilkan di Thumbnail?</label>
                    <?= form_dropdown('category_thumbnail', ['' => 'Pilih Status', 'Y' => 'Active', 'N' => 'Non Active'], $category['category_thumbnail'], ['class' => 'form-control', 'required' => 'required']) ?>
                </div>
                <div class="form-group">
                    ...
                    <?= form_input('category_keyword', $category['category_keyword'], ['class' => 'form-control', 'placeholder' => 'Keyword Kategori', 'required' => 'required']) ?>
                </div>
                <div class="form-group">
                    ...
                    <?= form_textarea('category_desc', $category['category_desc'], ['class' => 'form-control', 'placeholder' => 'Deskripsi Kategori', 'required' => 'required', 'cols' => 1]) ?>
                </div>
            </div>
