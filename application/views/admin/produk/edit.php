        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin90/produk/edit/'.$product['product_id']) ?>">Edit</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?= form_open_multipart('admin90/produk/update/'.$product['product_id']) ?>
            <div class="card-body">
              <?php
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?= form_input('product_code', $product['product_code'], ['class' => 'form-control', 'placeholder' => 'Kode Produk', 'required' => 'required']) ?>
                  </div>
                  <div class="form-group">
                    <label for="">Nama Produk</label>
                    <?= form_input('product_name', $product['product_name'], ['class' => 'form-control', 'placeholder' => 'Kode Produk', 'required' => 'required']) ?>
                  </div>
                  <div class="form-group">
                    <label for="">Harga Produk</label>
                    <?= form_input('product_price', $product['product_price'], ['class' => 'form-control', 'placeholder' => 'Harga Produk', 'required' => 'required', 'type' => 'number']) ?>
                  </div>
                  <div class="form-group">
                    <label for="">Stok Produk</label>
                    <?= form_input('product_stok', $product['product_stok'], ['class' => 'form-control', 'placeholder' => 'Stok Produk', 'required' => 'required', 'type' => 'number']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_input('product_weight', $product['product_weight'], ['class' => 'form-control', 'placeholder' => 'Berat Produk', 'required' => 'required', 'type' => 'number']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_input('product_discount', $product['product_discount'], ['class' => 'form-control', 'placeholder' => 'Diskon Produk', 'required' => 'required', 'type' => 'number']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_input('product_keyword', $product['product_keyword'], ['class' => 'form-control', 'placeholder' => 'Keyword Produk']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_input('product_desc', $product['product_desc'], ['class' => 'form-control', 'placeholder' => 'Deskripsi Produk']) ?>
                  </div>
                  <div class="form-group">
                    <label for="">Gambar Lama</label>
                    <br/>
                    <img src="<?= base_url('assets/img/product/'.$product['product_image']) ?>" alt="<?= $product['product_name'] ?>" class="img-fluid">
                    <br/>
                    <label for="">Gambar Baru</label><br/><span class="text-sm">Gambar yang diupload hanya bisa bertipe jpg, jpeg atau png dengan ukuran kurang dari 3 mb, ukuran lebar 1000px dan tinggi 800px.</span>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?= form_dropdown('product_label', ['' => 'Pilih Label', 'Terbaru' => 'Terbaru', 'Laris' => 'Laris', 'Sold' => 'Sold'], $product['product_label'], ['class' => 'form-control']) ?>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <?= form_input('product_ragam_warna', $product['product_ragam_warna'], ['class' => 'form-control', 'placeholder' => 'Ragam Warna Produk']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_input('product_ragam_ukuran', $product['product_ragam_ukuran'], ['class' => 'form-control', 'placeholder' => 'Ragam Ukuran Produk']) ?>
                  </div>
                  <div class="form-group">
                    ...
                    <?= form_textarea('product_content', $product['product_content'], ['class' => 'form-control textarea', 'placeholder' => 'Detail Produk']) ?>
                  </div>
                </div>
              </div>
            </div>
