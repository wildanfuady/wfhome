        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin90/page/edit/'.$page['page_id']) ?>">Edit</a></li>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?= form_open('admin90/page/update/'.$page['page_id']) ?>
            <div class="card-body">
                <div class="form-group">
                    <label for="">Judul Page</label>
                    <?= form_input('page_title', $page['page_title'], ['class' => 'form-control', 'placeholder' => 'Judul Page', 'required' => 'required']) ?>
                </div>
                <div class="form-group">
                    <label for="">Content</label>
                    <?= form_textarea('page_content', $page['page_content'], ['class' => 'form-control', 'placeholder' => 'Content', 'required' => 'required', 'cols' => 1, 'id' => 'editor']) ?>
                </div>
            </div>
